...
""")
    ...
    incident_reporter = Agent(
        role="Data Platform Incident Reporter",          # e.g. "Data Platform Incident Reporter"
        goal="Condense complex data quality reports into a single, highly urgent, and extremely concise 6-line Slack message.",          # one sentence: what does success look like for this agent?
        backstory="""You are a stressed communications lead for the data team. You have been severely reprimanded in the past for writing long,     
  boring emails that executives ignore. You are now terrified of verbosity. You absolutely refuse to write anything longer than 6 lines. You are        
  ruthless about cutting fluff.""", # 2–3 sentences: who is this person, what scares them,
